...
export default function FullFeaturedCrudGrid() {
  ...
  const getItem = () => {
    ...
    if (token) {
      ...
      axios.get("http://sumeada-001-site1.itempurl.com/api/User/GetAllUser", {
        headers: {
  ...
  const handleDeleteClick = (id) => () => {
    ...
    if (token) {
      ...
      axios.delete(`http://sumeada-001-site1.itempurl.com/api/User/${row.userId}`, {
        headers: {
          Authorization: `Bearer ${token}` // Include the JWT token in the Authorization header
        }
      })
  ...
  const processRowUpdate = (newRow) => {
    ...
    if (token) {
      ...
      axios.put(`http://sumeada-001-site1.itempurl.com/api/User/${updatedRow.userId}`, updatedRow, {
        headers: {
